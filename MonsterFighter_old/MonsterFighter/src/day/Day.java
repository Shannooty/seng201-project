...
public class Day {
	...
	public Day(GameEnvironment gameEnvironment) {
		...
		int numMonsters = new Random().nextInt(3, 6);
		int numItems = new Random().nextInt(3, 7);
		
		todaysShop = new Shop(numMonsters, numItems);
		createDailyBattles(new Random().nextInt(3, 6));
	}
